  ...
  return (
    <div className="max-w-lg mx-auto bg-white overflow-hidden md:max-w-4xl">
      <div className="flex justify-between items-start pt-12">
        <div>
          <h1 className="text-2xl font-bold text-gray-800">Xin chào, {props.user.fullName}</h1>
      ...
      <div className="mt-6 border-t border-gray-200 pt-6">
        <dl className="divide-y divide-gray-200">
          ...
          <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
            ...
            <dd className="mt-1 text-sm text-[var(--dark-black)] sm:mt-0 sm:col-span-2">{props.user.phoneNumber}</dd>
          </div>
          <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4">
